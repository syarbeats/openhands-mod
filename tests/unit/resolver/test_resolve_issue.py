...
def assert_sandbox_config(
    ...
    runtime_container_image='docker.all-hands.dev/all-hands-ai/runtime:0.39-nikolaik:mock-nikolaik',  # Default to mock version
...
def test_setup_sandbox_config_default():
    ...
    with mock.patch('openhands.__version__', 'mock'):
        ...
        assert_sandbox_config(
            config, runtime_container_image='docker.all-hands.dev/all-hands-ai/runtime:0.39-nikolaik:mock-nikolaik'
        )
